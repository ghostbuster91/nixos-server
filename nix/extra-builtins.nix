...
# to provide age decryption as an additional safe builtin.
#
...
in
{
  # Instead of calling age directly here, we call a wrapper script that will cache the output
